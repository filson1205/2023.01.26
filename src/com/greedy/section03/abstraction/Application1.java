...
public class Application1 {
	...
	public static void main(String[] args) {
		 ...
		 * 낮은 결합도(수정을 줄인다)와 높은 응집도(생산성 높인다) 추구 -> 유지보수성이 높아진다.
		 * 모든 객체는 책임을 가지고 자신의 역할을 수행한다. (명령에 대한 수행할 책임)
		...
		// 객체지향 설계 5원칙 (SPR,OCP,LSP,ISP,DIP -> SOLID)
		// 단일 책임의 원칙(SPR) : 하나의 클라이언트가 하나의 클래스를 수행한다.
		
		/* 추상화란?
		 * 공통된 부분을 추출하고 공통되지 않은 부분을 제거한다는 의미를 가진다.
		 * 추상화의 목적은 유연ㅅ어 확보와 복잡한 현실 세계의 단순화에 있다.
		 ...
		 * 5. 브레이크를 밟을 때 자동차가 달리는 중이 아니라면 이미 멈추있는 상태라고 안내한다.
