...
public class User {
	 ...
	 * 통상적으로는 필드 선언부와 메소드 선언부 상에 작성하는 것이 관례이다.
	 * */
...
//	public User() {}
	...
	/* 매개변수 있는 생성자 */
	public User(String id, String pwd, String name) { //매개변수가 있는 변수로서 동일한 변수명이지만 오버로딩을 통해서 사용가능
													//오버로딩(트럭에 쌓기) 과 오버라이딩(덮어쓰기) 차이점 알기
		this.id = id;
		this.pwd = pwd;
		this.name = name;
...
//		this.name = name;
		 ...
		 *  */
		this(id, pwd, name); //가장 윗줄에 작성되어야함 아니면 에러
